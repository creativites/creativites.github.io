  ...
  */
  ...
  Class.prototype.mark = function(td, YMD){
    ...
    return that;
  	...
  	//扩展 - 判断是数据否在数组
  	Class.prototype.hasFromArray = function(val,arr){
  ...
  Class.prototype.limit = function(elem, date, index, time){
    ...
    //扩展 - 判断 是否属于禁用
    var theday = thisDateTime.date;
    isOut = timestrap.now < timestrap.min || timestrap.now > timestrap.max || that.hasFromArray(theday,options.dislimit_day);
    //扩展 - 判断 是否属于禁用 end
